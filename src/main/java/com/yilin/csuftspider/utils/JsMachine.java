 ...
 * Title: JsMachine
 * Description: TODO
 * CSUFT 教务系统 教务系统密码加密 js代码 （java调用）
 * @author Yilin
 * @version V1.0
 * @date 2022-09-26
 */
public class JsMachine {


    public static String encryptJs(String pwd,String key)  {
        ...
        js = "var CryptoJS=CryptoJS||function(u,p){var d={},l=d.lib={},s=function(){},t=l.Base={extend:function(a){s.prototype=this;var c=new s;a&&c.mixIn(a);c.hasOwnProperty(\"init\")||(c.init=function(){c.$super.init.apply(this,arguments)});c.init.prototype=c;c.$super=this;return c},create:function(){var a=this.extend();a.init.apply(a,arguments);return a},init:function(){},mixIn:function(a){for(var c in a)a.hasOwnProperty(c)&&(this[c]=a[c]);a.hasOwnProperty(\"toString\")&&(this.toString=a.toString)},clone:function(){return this.init.prototype.extend(this)}},\n" +
        ...
        try {
            encryptedPwd = (String) inv.invokeFunction("encryptAES", pwd, key);
        } catch (ScriptException e) {
            e.printStackTrace();
